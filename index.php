                                        ...
                                        <a class="!no-underline" href="<?php echo '/doc/' . $project ?>">
                                            <h3 class="text-sm text-gray-700">
                                                ...
                                                <div class="inline-flex items-center px-2.5 py-0.25 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                                    <?php echo $this->getViews($this->conn, $docId, 'doc') ?> Views
                                                </div>
                                            </h3>
                                        </a>
                                    ...
                                    <div class="pt-3.5">
                                        <a class="!no-underline" href="<?php echo '/blog/' . $topic ?>">
                                            <h3 class="text-sm text-gray-700">
                                                <?php echo $topic; ?>
                                                <div class="inline-flex items-center px-2.5 py-0.25 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                                    <?php echo $this->getViews($this->conn, $blog_id, 'blog') ?> Views
                                                </div>
                                            </h3>
                                        </a>
                                        <p class="max-w-[40ch] text-xs text-gray-500">
                ...
                if (isset($_SESSION['original_password'])) {
                    ?>
                        ...
                        <body>
                            ...
                            <h1>Edit Action</h1>
                            <a href="/editAbout">Edit About</a>
                            <br>
                            <a href="/editBlog">Edit Blog</a>
                            <br>
                            <a href="/editDoc">Edit Doc</a>
                            <br>
                            <a href="/editLinktree">Edit Linktree</a>
                            <br>
                            <a href="/editTag">Edit Tag</a>

                            <h1>Delete Action</h1>
                            <a href="/deleteAttachTag">Delete Attached tag</a>
                            <br>
                            <a href="/deleteTag">Delete tag</a>
                            <br>
                            <a href="/deleteBlog">Delete Blog</a>
                            <br>
                            <a href="/deleteDoc">Delete Doc</a>
                            <br>
                            <a href="/deleteImage">Delete Image</a>
                            <br>
                        </body>
